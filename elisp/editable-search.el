...
;;; defvar
(defvar es-is-use-super t "*Mac-like behavior.")
(defvar es-is-deactivate-region-by-cursor t "*Mac-like behavior.")
...
;;; hook
;; markerがある状態でshiftなしのカーソルが打鍵されたらリージョンを解除
(when es-is-deactivate-region-by-cursor
	(progn
		...
		(defun post-command-hook-fn ()
			...
			;; (message "this-event:  %s" last-input-event)
